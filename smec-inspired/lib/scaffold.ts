 ...
 *
 * smec.com leans on large photography and SMEC Oil & Gas does not yet have
 * enough of its own, so these stock photographs (Wikimedia Commons, reuse
 * licences) stand in until client assets arrive.
 *
...
/** Hero slideshow — rotates behind the (unchanged) hero copy, after the real banner. */
...
/** Stats band — wide photograph behind the counters. */
export const SCAFFOLD_STATS_BAND: ScaffoldImage = {
  id: 'stats-refinery-panorama',
  src: '/images/scaffold/SCAFFOLD-stats-refinery-panorama.jpg',
  alt: 'Refinery at blue hour',
