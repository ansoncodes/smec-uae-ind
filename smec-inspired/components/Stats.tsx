...
import { SCAFFOLD_STATS_BAND } from '@/lib/scaffold';
...
/** Counters on a full-bleed photographic band with a navy scrim. */
export default function Stats() {
  return (
    <section className={styles.section} aria-label="SMEC by the numbers">
      {/* SCAFFOLD IMAGE: placeholder photograph behind the counters — replace via lib/scaffold.ts */}
      <Image
        src={SCAFFOLD_STATS_BAND.src}
        alt=""
        fill
        sizes="100vw"
        className={styles.bg}
        data-scaffold={SCAFFOLD_STATS_BAND.id}
      />
