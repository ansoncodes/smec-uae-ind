...
/**
 * Blue "connect" band ahead of the footer, in the manner of smec.com.
 * Presentation only: every string here already exists elsewhere on the page
 * (the support label and entity name from the footer address, the contact
 * details from the header, the Contact Us link from the hero).
 */
    ...
    <section className={styles.band} aria-label="Contact SMEC Oil and Gas">
      <div className={`container ${styles.inner}`}>
        ...
        <div className={styles.actions}>
          ...
          <a href={HERO.cta.href} className={styles.button}>
            {HERO.cta.label}
          </a>
        </div>
      </div>
